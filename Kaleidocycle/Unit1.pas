...
uses
  ...
  ExtCtrls, StdCtrls, Buttons, Spin, XPMan, Dialogs;
...
procedure tForm1.kaleidober(Sender: TObject);
var
  radius: integer;
  laenge:integer;
  i,anz:integer;
...
procedure TForm1.Paintwmf(can:tcanvas);
...
procedure TForm1.D29C(Sender: TObject);
begin
