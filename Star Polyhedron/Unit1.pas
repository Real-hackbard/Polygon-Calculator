...
uses
  ...
  Buttons, StdCtrls, ExtCtrls, Mask, Zlib, Spin, XPMan;
...
procedure TForm1.S9C(Sender: TObject);
var i:integer;
begin
  Z:=z/1.1;
  for i:=0 to verdecktzahl-1 do begin
...
procedure TForm1.S1C(Sender: TObject);
var i:integer;
begin
  for i:=0 to verdecktzahl-1 do begin
    t[i].x:=t[i].x/z*150;
...
procedure TForm1.T3C(Sender: TObject);
begin
...
procedure TForm1.Rx1Change(Sender: TObject);
begin
  if kabbruch and (not nichtschalten) then zeichnen(sender);
end;

procedure TForm1.CB2C(Sender: TObject);
begin
  hpunkte:=cb2.checked;
  zeichnen(sender);
end;

procedure TForm1.Rx2Change(Sender: TObject);
var i:integer;
    faktor:double;
begin
